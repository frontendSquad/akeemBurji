                                    ...
                                    <div class="row">
                                        <div class="col-xl-8 col-lg-10 offset-xl-1">
                                            ...
                                            <div class="mainDetail d-lg-flex my-2 gap60">
                                                ...
                                                <p class="mainText">Abc Address</p>
                                            </div>
                                            <div class="mainDetail d-lg-flex my-2 gap60">
                                                <label for="" class="mainLabel">Tell us about your religion background (Example: Muslim, Buddha, etc.):<span class="text-danger">*</span></label>
                                                <p class="mainText">Lorem ipsum dolor sit amet,</p>
                                            </div>
                                            <div class="mainDetail d-lg-flex my-2 gap60">
                                                <label for="" class="mainLabel">Personal Statement:<span class="text-danger">*</span></label>
                                                <p class="mainText">Lorem ipsum dolor sit amet,Lorem ipsum dolor sit amet, Lorem ipsum dolor sit amet,</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
