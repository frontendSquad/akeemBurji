                                        ...
                                        <div class="col-12">
                                            <div class="back-title mt-1">
                                                ...
                                                <div class="pageTitleInner">
                                                    <h1 class="page-title text-capitalize m-0">Edit Blog</h1>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xl-8 col-lg-10">
                                            <form action="blogs.php">
                                                ...
                                                <div class="mainDetail d-lg-flex my-2 align-items-baseline gap60">
                                                    ...
                                                    <div class="w-100">
                                                        <input type="text" class="mainInput" placeholder="Enter Blog Title" value="A Blog Title">
                                                    </div>
                                                </div>
                                                <div class="mainDetail d-lg-flex my-2 align-items-baseline gap60">
                                                ...
                                                <div class="mainDetail d-lg-flex my-2 align-items-baseline gap60">
                                                    ...
                                                    <button type="button" class="siteBtn" data-toggle="modal" data-target="#editedBlog">Update</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
