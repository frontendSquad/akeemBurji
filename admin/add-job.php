                                        ...
                                        <div class="col-12">
                                            <div class="back-title mt-1">
                                                ...
                                                <div class="pageTitleInner">
                                                    <h1 class="page-title text-capitalize m-0">Add Jobs</h1>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xl-10 offset-xl-1">
                                            <form action="">
                                                <div class="mainDetail d-lg-flex my-2 align-items-baseline gap60">
                                                    ...
                                                    <div class="w-100">
                                                        <input type="text" class="mainInput" placeholder="Enter Job Title">
                                                    </div>
                                                </div>
                                                <div class="mainDetail d-lg-flex my-2 align-items-baseline gap60">
                                                    <label for="" class="mainLabel">Job Location<span class="text-danger">*</span>:</label>
                                                    <div class="w-100">
                                                        <input type="text" class="mainInput" placeholder="Enter Job Location">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mainDetail d-lg-flex my-2 gap60">
                                                    ...
                                                    <div class="w-100">
                                                        <button type="button" class="siteBtn" data-toggle="modal" data-target="#jobPosted">Post Job</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
