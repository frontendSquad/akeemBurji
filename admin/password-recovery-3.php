                    ...
                    <div class="formBox">
                        ...
                        <form action="login.php" method="POST" class="py-2">
                            <div class="form-field">
                                <label for="" class="site-label">New Password<span class="red">*</span>:</label>
                            ...
                            <div class="form-field ">
                                <label for="" class="site-label">Confirm New Password<span class="red">*</span>:</label>
                                <div class="position-relative passwordWrapper">
                                    <input type="password" class="site-input passInput" placeholder="Confirm Password">
                                    <i class="fas fa-eye-slash passDisplay" aria-hidden="true"></i>
                                </div>
                            </div>
                            <div class="form-field mt-2 mt-lg-3">
                                <button type="submit" class="siteBtn w-100">Update</button>
                            </div>
