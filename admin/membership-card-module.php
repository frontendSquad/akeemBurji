                                ...
                                <div class="card-dashboard">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-xl-6 text-right">
                                            <a href="create-membership-card-1.php" class="siteBtn mt-1">Create New Membership Card</a>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-12">
                                            <span class="pillSpan my-3">
                                                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                                    <li class="nav-item">
                                                        <a href="membership-card-module.php" class="nav-link active">Membership Cards</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="membership-card-module-2.php" class="nav-link">Templates</a>
                                                    </li>
                                                </ul>
                                            </span>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="dataTables_length text-left">
                                                <div class="user-listing-top  dashCard py-2 px-2">
                                                    ...
                                                    <div class="d-xl-flex align-items-end flex-wrap mb-xl-1">
                                                        <div class="userInput mb-2">
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu text-left custom-dropdown" x-placement="bottom-start">
                                                                        <a class="dropdown-item" href="view-membership-card.php">
