                                        ...
                                        <div class="col-xl-6">
                                            <div class="back-title mt-1">
                                                <div class="pageTitleInner">
                                                    <h1 class="page-title text-capitalize m-0">Video Management</h1>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 text-right">
                                            <a href="add-video.php" class="siteBtn mt-1">Add New Video Track</a>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-12">
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu text-left custom-dropdown" x-placement="bottom-start">
                                                                        <a class="dropdown-item" href="edit-video.php">
