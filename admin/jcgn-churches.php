                                        ...
                                        <div class="col-xl-6">
                                            <div class="back-title mt-1">
                                                <div class="pageTitleInner">
                                                    <h1 class="page-title text-capitalize m-0">JCGN Churches</h1>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 text-right">
                                            <button type="button" data-toggle="modal" data-target="#addChurch" class="siteBtn mt-1">Add New Church</button>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-12">
                                            ...
                                            <div class="maain-tabble table-responsive">
                                                <table class="table table-striped table-bordered zero-configuration">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu text-left custom-dropdown" x-placement="bottom-start">
                                                                        <a class="dropdown-item" href="view-church.php">
                                                                            <i class="far fa-eye"></i>View</a>
                                                                        <button type="button" data-toggle="modal" data-target="#inactiveChurch" class="dropdown-item">
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu text-left custom-dropdown" x-placement="bottom-start">
                                                                        <a class="dropdown-item" href="view-church.php">
                                                                            <i class="far fa-eye"></i>View</a>
                                                                        <button type="button" data-toggle="modal" data-target="#activeChurch" class="dropdown-item">
                                                        ...
                                                        <tr>
                                                            <td>05</td>
                                                            <td>Bethsaida Bulondo Church</td>
                                                            <td>03/02/2020</td>
                                                            <td>123</td>
                                                            <td>Active</td>
                                                            <td>
