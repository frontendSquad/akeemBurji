                                        ...
                                        <div class="col-12">
                                            <div class="back-title mt-1">
                                                ...
                                                <div class="pageTitleInner">
                                                    <h1 class="page-title text-capitalize m-0">Edit Template</h1>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xl-10 offset-xl-1">
                                            <form action="" method="POST">
                                                <div class="mainDetail d-lg-flex align-items-baseline my-2 gap60">
                                                    ...
                                                    <div class="w-100">
                                                        <input type="text" class="mainInput" placeholder="Enter Template Name" value="Template ABC">
                                                    </div>
                                                </div>
                                                <div class="mainDetail d-lg-flex align-items-baseline my-2 gap60">
                                                    <label for="" class="mainLabel">Field Title<span class="text-danger">*</span>:</label>
                                                    <div class="w-100">
                                                        <input type="text" class="mainInput" placeholder="Enter Title" value="Name">
                                                        <div class="appendBtn">
                                                ...
                                                <div class="mainDetail d-lg-flex align-items-baseline my-2 gap60">
                                                    ...
                                                    <div class="w-100">
                                                        <select name="" id="" class="mainInput">
                                                            <option value="s" hidden disabled>Select Type</option>
                                                ...
                                                <div class="mainDetail d-lg-flex align-items-baseline my-2 gap60">
                                                    ...
                                                    <div class="w-100 d-flex align-items-center">
                                                        <label class="switch mr-2">
                                                            <input type="checkbox" class="templateStatusBox" checked>
                                                ...
                                                <div class="mainDetail d-lg-flex align-items-baseline my-2 gap60">
                                                    ...
                                                    <div class="w-100">
                                                        <button class="siteBtn">Save</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
