                                        ...
                                        <div class="col-12">
                                            <div class="back-title mt-1">
                                                ...
                                                <div class="pageTitleInner">
                                                    <h1 class="page-title text-capitalize m-0">Edit Audio Track</h1>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xl-10 offset-xl-1">
                                            <form action="audio-management.php" method="POST">
                                                ...
                                                <div class="mainDetail d-lg-flex my-2 align-items-baseline gap60">
                                                    ...
                                                    <div class="w-100">
                                                        <button type="button" data-toggle="modal" data-target="#editAudioTrack" class="siteBtn mb-1">Edit Track</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
