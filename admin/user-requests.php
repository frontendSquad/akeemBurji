                                        ...
                                        <div class="col-12">
                                            <div class="back-title mt-1">
                                                <div class="pageTitleInner">
                                                    <h1 class="page-title text-capitalize m-0">Form Submitted By Users</h1>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="dataTables_length text-left">
                                                <div class="user-listing-top  dashCard py-2 px-2">
                                                    ...
                                                    <div class="d-xl-flex align-items-end flex-wrap justify-content-between mb-xl-1">
                                                        ...
                                                        <div class="userInput mb-2">
                                                            <label class="dashLabel d-inline-block mb-1 mb-xl-0">Form Type:</label>
                                                            <select class="d-inline-block dashInput">
                                                                <option value="" disabled="" hidden="" selected="">Select</option>
                                                                <option value="1">Appointment to Paster/Staff User</option>
                                                                <option value="2">Become Volunteer</option>
                                                                <option value="3">An Expertise Presentation</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu text-left custom-dropdown" x-placement="bottom-start">
                                                                        <a class="dropdown-item" href="user-request-details.php">
